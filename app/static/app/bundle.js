...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onSubmit() {
            ...
            this.isLoading = true;
            if (true) {
                this.URLstring = `${{"ROOT_URL":"http://127.0.0.1","PORT":8000}.ROOT_URL}:${{"ROOT_URL":"http://127.0.0.1","PORT":8000}.PORT}`;
...
var routes = [{ path: "/", component: _Home2.default }, { path: "/contact", component: _Contact2.default }, { path: "/projects", component: _Projects2.default }];
